...
class Enemigo:
    def __init__(self,x,y,speed_walk,speed_run,gravity,jump_power,frame_rate_ms,move_rate_ms,jump_height,healt) -> None:
         self.walk_r = Auxiliar.getSurfaceFromSpriteSheet("images/caracters/green_hat/walk.png",15,1)[:12]
         self.walk_l = Auxiliar.getSurfaceFromSpriteSheet("images/caracters/green_hat/walk.png",15,1,True)[:12]
         self.stay_r = Auxiliar.getSurfaceFromSpriteSheet("images/caracters/green_hat/idle.png",16,1)
         self.stay_l = Auxiliar.getSurfaceFromSpriteSheet("images/caracters/green_hat/idle.png",16,1,True)
         self.jump_r = Auxiliar.getSurfaceFromSpriteSheet("images/caracters/green_hat/jump.png",33,1,False,2)
         self.jump_l = Auxiliar.getSurfaceFromSpriteSheet("images/caracters/green_hat/jump.png",33,1,True,2)
         self.frame = 0
         self.lived = 1
         self.x_spot = x
         self.y_spot = y
