...
def mostar_ranking():
    while True:
        ...
        QUIT_BUTTON = Button(image=pygame.image.load("Menu/assets/Quit Rect.png"), pos=((ANCHO_VENTANA/2), 550), 
...
def seleccionar_nivel():
    while True:
            ...
            LEVEL1_BUTTON = Button(image=pygame.image.load("Menu/assets/Play Rect.png"), pos=((ANCHO_VENTANA/2), 250), 
                    text_input="NIVEL 1", font=fuente, base_color="#d7fcd4", hovering_color="Black")
            LEVEL2_BUTTON = Button(image=pygame.image.load("Menu/assets/Options Rect.png"), pos=((ANCHO_VENTANA/2), 400), 
                    text_input="NIVEL 2", font=fuente, base_color="#d7fcd4", hovering_color="Black")
            LEVEL3_BUTTON = Button(image=pygame.image.load("Menu/assets/Quit Rect.png"), pos=((ANCHO_VENTANA/2), 550), 
...
def main_menu():
    ...
    while True:
        ...
        PLAY_BUTTON = Button(image=pygame.image.load("Menu/assets/Play Rect.png"), pos=((ANCHO_VENTANA/2), 250), 
                            text_input="JUGAR", font=fuente, base_color="#d7fcd4", hovering_color="Black")
        OPTIONS_BUTTON = Button(image=pygame.image.load("Menu/assets/Options Rect.png"), pos=((ANCHO_VENTANA/2), 400), 
...
def play(pausa,level):
   # sound = pygame.mixer.Sound(r"Sounds\laser5.ogg")
    ...
    player_1 = Player(x=0,y=400,speed_walk=4,speed_run=8,gravity=8,jump_power=25,frame_rate_ms=80,move_rate_ms=10,jump_height=150,energia=100,bullets=100,healt=100, live=1)
    ...
    if level == 1:
        ...
        imagen_fondo = pygame.image.load("images/locations/city/all.png")
        ...
        for player in lista_players:
            if player.win == True:
                ...
                mostar_ranking()    
                 ...
                 player.events(keys)
                 player.update(delta_ms,lista_plataformas,lista_balas,lista_players,lista_botiquines,lista_trampas,lista_portales,lista_botines)
                 player.draw(screen)
